<?php
/*
 * Gallery Name: Slideshow w prawej kolumnie
 * Description: Pokaz slajdów w prwej kolumnie, tytuł w lewej
 */
class Slideshowcolumn {
    ...
    $prev_next = '<div class="swiper-button-next"></div><div class="swiper-button-prev"></div>';



	$output = '<div class="swiper-container">'.$prev_next . '<ul class="swiper-wrapper">';
	$i = 0;
	...
	foreach ( $attachments as $id => $attachment ) {
		...
		$output .= '<li class="swiper-slide">'.$link.'</li>';
