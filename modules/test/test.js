...
//this.templates.window = wp.template( "aut0poietic-modal-window" );
			console.log(this.$el);
				//this.ui.content = this.templates.edit({a: d.getTime()});
			this.templates.edit = wp.template( "shortcode-default-edit-form" );
		   //this.render();
		   this.$el.find('.backbone_modal-content').html( this.templates.edit() );
		},
insert: function(e){
    "use strict";
e.preventDefault();
...
var d = new Date();
			...
			this.$el.attr( 'tabindex', '0' )
				.append( this.templates.window({a: d.getTime()}) )
